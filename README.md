...
[**Chokepoint-universal.zip**](https://github.com/cpatil/chokepoint/releases/latest/download/Chokepoint-universal.zip)
...
```bash
./build.sh          # -> build/Chokepoint.app
open build/Chokepoint.app
```

If you do want the download, verify it against the checksum published in the
[release notes](https://github.com/cpatil/chokepoint/releases/latest) first, then:

```bash
shasum -a 256 Chokepoint-universal.zip     # compare with the release notes
